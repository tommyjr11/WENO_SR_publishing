#!/usr/bin/env python3
"""Trusted WENO5/RK3 runner with V12 reflection-symmetric MLP inference."""
...
from teacherfree_lab_weno5_v12_reflection_sym.warp_v12.weno5_rk3_diff_v12 import (
...
def load_mlp_params(model_path: Path, device: str) -> dict[str, object]:
    ...
    return {
        name: wp.array(data[name], dtype=wp.float64, device=device, requires_grad=False)
