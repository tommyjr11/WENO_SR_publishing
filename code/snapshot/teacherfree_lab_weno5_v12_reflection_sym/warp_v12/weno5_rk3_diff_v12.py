#!/usr/bin/env python3
"""Trusted WENO5/RK3 path with reflection-symmetric V12 MLP inference.

The numerical kernels are copied from the validated V9 path. This isolated
online-validation copy disables backward-code generation because Sod inference
never opens a Warp tape; forward state, flux, characteristic, Riemann, and RK3
