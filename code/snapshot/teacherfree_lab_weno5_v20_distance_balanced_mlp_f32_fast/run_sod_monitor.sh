#!/usr/bin/env bash
# Launch the trusted characteristic/Evilin mixed-precision Sod monitor.
set -euo pipefail
...
RUN_DIR="${RUN_DIR:-runs/apost_weno5_v20_mlp_f32_fast_a800_200k}"
...
echo "launched trusted mixed-FP32 Sod monitor on GPU $GPU_ID pid=$pid"
