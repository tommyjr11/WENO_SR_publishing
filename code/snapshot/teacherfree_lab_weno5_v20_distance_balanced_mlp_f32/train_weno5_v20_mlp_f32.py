#!/usr/bin/env python3
"""Train WENO5 V20 with only the reflection-symmetric MLP in FP32."""
...
from teacherfree_lab_weno5_v20_distance_balanced_mlp_f32.v20_losses import (
