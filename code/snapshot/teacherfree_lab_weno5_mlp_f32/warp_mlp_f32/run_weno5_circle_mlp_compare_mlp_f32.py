#!/usr/bin/env python3
"""Compare classical and MLP WENO5/RK3 on a circular Sod problem."""
...
from teacherfree_lab_weno5_mlp_f32.warp_mlp_f32.weno5_rk3_diff_mlp_f32 import (
...
def run_classical_solution(
    ...
    while t < t_end - 1.0e-14:
        ...
        u = advance_one_step(u, params, dt, device, None, False, boundary, characteristic_weno, "evilin")
        t += dt
        steps += 1
        dt_values.append(dt)
