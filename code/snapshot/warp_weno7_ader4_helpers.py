...
if wp is not None:
    ...
    def weno7_lr_scalar_mlp(
        ...
        if lr == 1:
            ...
            d3 = wp.float64(1.0) / wp.float64(35.0)
        if lr == 1:
            beta = weno7_mlp_beta(q0, q1, q2, q3, q4, q5, q6, w1, b1, w2, b2, w3, b3, w4, b4)
        else:
            beta_r = weno7_mlp_beta(q6, q5, q4, q3, q2, q1, q0, w1, b1, w2, b2, w3, b3, w4, b4)
            beta = wp.vec4d(beta_r[3], beta_r[2], beta_r[1], beta_r[0])
        ...
        return scale_derivative(ww0 * s0 + ww1 * s1 + ww2 * s2 + ww3 * s3, h, dorder)


    @wp.func
    def weno7_gauss_lr_scalar_mlp(
        q0: wp.float64,
        q1: wp.float64,
        q2: wp.float64,
        q3: wp.float64,
    ...
    @wp.func
    def weno7_lr_vec_conservative_mlp(
        q0: wp.vec4d,
        q1: wp.vec4d,
        q2: wp.vec4d,
        q3: wp.vec4d,
        ...
        return wp.vec4d(
            weno7_lr_scalar_mlp(q0[0], q1[0], q2[0], q3[0], q4[0], q5[0], q6[0], lr, h, dorder, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff),
            weno7_lr_scalar_mlp(q0[1], q1[1], q2[1], q3[1], q4[1], q5[1], q6[1], lr, h, dorder, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff),
            weno7_lr_scalar_mlp(q0[2], q1[2], q2[2], q3[2], q4[2], q5[2], q6[2], lr, h, dorder, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff),
            weno7_lr_scalar_mlp(q0[3], q1[3], q2[3], q3[3], q4[3], q5[3], q6[3], lr, h, dorder, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff),
        )


    @wp.func
    def weno7_gauss_vec_conservative_mlp(
        q0: wp.vec4d,
        q1: wp.vec4d,
        q2: wp.vec4d,
        q3: wp.vec4d,
        ...
        return wp.vec4d(
            weno7_gauss_lr_scalar_mlp(q0[0], q1[0], q2[0], q3[0], q4[0], q5[0], q6[0], lr, h, dorder, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff),
            weno7_gauss_lr_scalar_mlp(q0[1], q1[1], q2[1], q3[1], q4[1], q5[1], q6[1], lr, h, dorder, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff),
            weno7_gauss_lr_scalar_mlp(q0[2], q1[2], q2[2], q3[2], q4[2], q5[2], q6[2], lr, h, dorder, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff),
            weno7_gauss_lr_scalar_mlp(q0[3], q1[3], q2[3], q3[3], q4[3], q5[3], q6[3], lr, h, dorder, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff),
        )
    ...
    @wp.func
    def weno7_lr_vec_characteristic_mlp(
        q0: wp.vec4d,
        q1: wp.vec4d,
        q2: wp.vec4d,
        q3: wp.vec4d,
        ...
        c6 = con_to_char(q6, roe, direction, gamma)
        cf = wp.vec4d(
            weno7_lr_scalar_mlp(c0[0], c1[0], c2[0], c3[0], c4[0], c5[0], c6[0], lr, h, dorder, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff),
            weno7_lr_scalar_mlp(c0[1], c1[1], c2[1], c3[1], c4[1], c5[1], c6[1], lr, h, dorder, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff),
            weno7_lr_scalar_mlp(c0[2], c1[2], c2[2], c3[2], c4[2], c5[2], c6[2], lr, h, dorder, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff),
            weno7_lr_scalar_mlp(c0[3], c1[3], c2[3], c3[3], c4[3], c5[3], c6[3], lr, h, dorder, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff),
        )
        return char_to_con(cf, roe, direction, gamma)
    ...
    @wp.kernel
    def compute_x_stage_weno7_mlp_big_kernel(
        ...
        if j < ny + 8 and i < nx + 2:
            ...
            q5 = vec_from_array(u, j, i + 5)
            q6 = vec_from_array(u, j, i + 6)
            write_vec(l0, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 2, dx, 0, 1, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
            write_vec(r0, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 1, dx, 0, 1, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
            if mlp_value_only == 1:
                write_vec(l1, j, i, weno7_lr_vec_characteristic(q0, q1, q2, q3, q4, q5, q6, 2, dx, 1, 1, gamma))
                write_vec(r1, j, i, weno7_lr_vec_characteristic(q0, q1, q2, q3, q4, q5, q6, 1, dx, 1, 1, gamma))
                write_vec(l2, j, i, weno7_lr_vec_characteristic(q0, q1, q2, q3, q4, q5, q6, 2, dx, 2, 1, gamma))
                ...
                write_vec(l1, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 2, dx, 1, 1, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
                write_vec(r1, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 1, dx, 1, 1, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
                write_vec(l2, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 2, dx, 2, 1, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
                write_vec(r2, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 1, dx, 2, 1, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
                write_vec(l3, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 2, dx, 3, 1, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
                write_vec(r3, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 1, dx, 3, 1, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))


    @wp.kernel
    def compute_y_stage_weno7_mlp_big_kernel(
        u: wp.array3d(dtype=wp.float64),
        l0: wp.array3d(dtype=wp.float64),
        r0: wp.array3d(dtype=wp.float64),
        l1: wp.array3d(dtype=wp.float64),
        ...
        if j < ny + 2 and i < nx + 8:
            ...
            q5 = vec_from_array(u, j + 5, i)
            q6 = vec_from_array(u, j + 6, i)
            write_vec(l0, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 2, dy, 0, 2, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
            write_vec(r0, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 1, dy, 0, 2, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
            if mlp_value_only == 1:
                write_vec(l1, j, i, weno7_lr_vec_characteristic(q0, q1, q2, q3, q4, q5, q6, 2, dy, 1, 2, gamma))
                write_vec(r1, j, i, weno7_lr_vec_characteristic(q0, q1, q2, q3, q4, q5, q6, 1, dy, 1, 2, gamma))
                write_vec(l2, j, i, weno7_lr_vec_characteristic(q0, q1, q2, q3, q4, q5, q6, 2, dy, 2, 2, gamma))
                ...
                write_vec(l1, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 2, dy, 1, 2, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
                write_vec(r1, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 1, dy, 1, 2, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
                write_vec(l2, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 2, dy, 2, 2, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
                write_vec(r2, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 1, dy, 2, 2, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
                write_vec(l3, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 2, dy, 3, 2, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
                write_vec(r3, j, i, weno7_lr_vec_characteristic_mlp(q0, q1, q2, q3, q4, q5, q6, 1, dy, 3, 2, gamma, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff))
    ...
    @wp.func
    def cross_x_one_side_mlp(
        a0: wp.array3d(dtype=wp.float64),
        a1: wp.array3d(dtype=wp.float64),
        a2: wp.array3d(dtype=wp.float64),
        a3: wp.array3d(dtype=wp.float64),
        j: int,
        i: int,
        lr: int,
        dy: wp.float64,
        ...
        q20 = vec_from_array(a2, j + 1, i); q21 = vec_from_array(a2, j + 2, i); q22 = vec_from_array(a2, j + 3, i); q23 = vec_from_array(a2, j + 4, i); q24 = vec_from_array(a2, j + 5, i); q25 = vec_from_array(a2, j + 6, i); q26 = vec_from_array(a2, j + 7, i)
        q30 = vec_from_array(a3, j + 1, i); q31 = vec_from_array(a3, j + 2, i); q32 = vec_from_array(a3, j + 3, i); q33 = vec_from_array(a3, j + 4, i); q34 = vec_from_array(a3, j + 5, i); q35 = vec_from_array(a3, j + 6, i); q36 = vec_from_array(a3, j + 7, i)
        u = weno7_gauss_vec_conservative_mlp(q00, q01, q02, q03, q04, q05, q06, lr, dy, 0, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
        if mlp_value_only == 1:
            uy = weno7_gauss_vec_conservative(q00, q01, q02, q03, q04, q05, q06, lr, dy, 1)
            uyy = weno7_gauss_vec_conservative(q00, q01, q02, q03, q04, q05, q06, lr, dy, 2)
            uyyy = weno7_gauss_vec_conservative(q00, q01, q02, q03, q04, q05, q06, lr, dy, 3)
            ...
            uy = weno7_gauss_vec_conservative_mlp(q00, q01, q02, q03, q04, q05, q06, lr, dy, 1, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uyy = weno7_gauss_vec_conservative_mlp(q00, q01, q02, q03, q04, q05, q06, lr, dy, 2, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uyyy = weno7_gauss_vec_conservative_mlp(q00, q01, q02, q03, q04, q05, q06, lr, dy, 3, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            ux = weno7_gauss_vec_conservative_mlp(q10, q11, q12, q13, q14, q15, q16, lr, dy, 0, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uxy = weno7_gauss_vec_conservative_mlp(q10, q11, q12, q13, q14, q15, q16, lr, dy, 1, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uxyy = weno7_gauss_vec_conservative_mlp(q10, q11, q12, q13, q14, q15, q16, lr, dy, 2, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uxx = weno7_gauss_vec_conservative_mlp(q20, q21, q22, q23, q24, q25, q26, lr, dy, 0, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uxxy = weno7_gauss_vec_conservative_mlp(q20, q21, q22, q23, q24, q25, q26, lr, dy, 1, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uxxx = weno7_gauss_vec_conservative_mlp(q30, q31, q32, q33, q34, q35, q36, lr, dy, 0, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
        qt, qtt, qttt = compute_euler_time_derivatives_2d_order3(u, ux, uy, uxx, uxy, uyy, uxxx, uxxy, uxyy, uyyy, gamma)
        return after_dritq_2d(qt, qtt, qttt, u, loca, dt)


    @wp.func
    def cross_y_one_side_mlp(
        a0: wp.array3d(dtype=wp.float64),
        a1: wp.array3d(dtype=wp.float64),
        a2: wp.array3d(dtype=wp.float64),
        a3: wp.array3d(dtype=wp.float64),
        ...
        q20 = vec_from_array(a2, j, i + 1); q21 = vec_from_array(a2, j, i + 2); q22 = vec_from_array(a2, j, i + 3); q23 = vec_from_array(a2, j, i + 4); q24 = vec_from_array(a2, j, i + 5); q25 = vec_from_array(a2, j, i + 6); q26 = vec_from_array(a2, j, i + 7)
        q30 = vec_from_array(a3, j, i + 1); q31 = vec_from_array(a3, j, i + 2); q32 = vec_from_array(a3, j, i + 3); q33 = vec_from_array(a3, j, i + 4); q34 = vec_from_array(a3, j, i + 5); q35 = vec_from_array(a3, j, i + 6); q36 = vec_from_array(a3, j, i + 7)
        u = weno7_gauss_vec_conservative_mlp(q00, q01, q02, q03, q04, q05, q06, lr, dx, 0, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
        if mlp_value_only == 1:
            ux = weno7_gauss_vec_conservative(q00, q01, q02, q03, q04, q05, q06, lr, dx, 1)
            uxx = weno7_gauss_vec_conservative(q00, q01, q02, q03, q04, q05, q06, lr, dx, 2)
            uxxx = weno7_gauss_vec_conservative(q00, q01, q02, q03, q04, q05, q06, lr, dx, 3)
            ...
            ux = weno7_gauss_vec_conservative_mlp(q00, q01, q02, q03, q04, q05, q06, lr, dx, 1, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uxx = weno7_gauss_vec_conservative_mlp(q00, q01, q02, q03, q04, q05, q06, lr, dx, 2, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uxxx = weno7_gauss_vec_conservative_mlp(q00, q01, q02, q03, q04, q05, q06, lr, dx, 3, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uy = weno7_gauss_vec_conservative_mlp(q10, q11, q12, q13, q14, q15, q16, lr, dx, 0, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uxy = weno7_gauss_vec_conservative_mlp(q10, q11, q12, q13, q14, q15, q16, lr, dx, 1, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uxxy = weno7_gauss_vec_conservative_mlp(q10, q11, q12, q13, q14, q15, q16, lr, dx, 2, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uyy = weno7_gauss_vec_conservative_mlp(q20, q21, q22, q23, q24, q25, q26, lr, dx, 0, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uxyy = weno7_gauss_vec_conservative_mlp(q20, q21, q22, q23, q24, q25, q26, lr, dx, 1, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
            uyyy = weno7_gauss_vec_conservative_mlp(q30, q31, q32, q33, q34, q35, q36, lr, dx, 0, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff)
        qt, qtt, qttt = compute_euler_time_derivatives_2d_order3(u, ux, uy, uxx, uxy, uyy, uxxx, uxxy, uxyy, uyyy, gamma)
        return after_dritq_2d(qt, qtt, qttt, u, loca, dt)
    ...
    @wp.kernel
    def compute_x_cross_stage_ader4_mlp_kernel(
        tl1: wp.array3d(dtype=wp.float64),
        tl2: wp.array3d(dtype=wp.float64),
        tl3: wp.array3d(dtype=wp.float64),
        tr1: wp.array3d(dtype=wp.float64),
        tr2: wp.array3d(dtype=wp.float64),
        tr3: wp.array3d(dtype=wp.float64),
        l0: wp.array3d(dtype=wp.float64),
        r0: wp.array3d(dtype=wp.float64),
        l1: wp.array3d(dtype=wp.float64),
        r1: wp.array3d(dtype=wp.float64),
        ...
        j, i = wp.tid()
        if j < ny and i < nx + 2:
            write_vec(tl1, j, i, cross_x_one_side_mlp(l0, l1, l2, l3, j, i, loca, dy, dt, gamma, 1, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff, mlp_value_only))
            write_vec(tl2, j, i, cross_x_one_side_mlp(l0, l1, l2, l3, j, i, loca, dy, dt, gamma, 2, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff, mlp_value_only))
            write_vec(tl3, j, i, cross_x_one_side_mlp(l0, l1, l2, l3, j, i, loca, dy, dt, gamma, 3, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff, mlp_value_only))
            write_vec(tr1, j, i, cross_x_one_side_mlp(r0, r1, r2, r3, j, i, loca, dy, dt, gamma, 1, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff, mlp_value_only))
            write_vec(tr2, j, i, cross_x_one_side_mlp(r0, r1, r2, r3, j, i, loca, dy, dt, gamma, 2, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff, mlp_value_only))
            write_vec(tr3, j, i, cross_x_one_side_mlp(r0, r1, r2, r3, j, i, loca, dy, dt, gamma, 3, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff, mlp_value_only))


    @wp.kernel
    def compute_y_cross_stage_ader4_mlp_kernel(
        tl1: wp.array3d(dtype=wp.float64),
        tl2: wp.array3d(dtype=wp.float64),
        tl3: wp.array3d(dtype=wp.float64),
        tr1: wp.array3d(dtype=wp.float64),
        ...
        j, i = wp.tid()
        if j < ny + 2 and i < nx:
            write_vec(tl1, j, i, cross_y_one_side_mlp(l0, l1, l2, l3, j, i, loca, dx, dt, gamma, 1, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff, mlp_value_only))
            write_vec(tl2, j, i, cross_y_one_side_mlp(l0, l1, l2, l3, j, i, loca, dx, dt, gamma, 2, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff, mlp_value_only))
            write_vec(tl3, j, i, cross_y_one_side_mlp(l0, l1, l2, l3, j, i, loca, dx, dt, gamma, 3, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff, mlp_value_only))
            write_vec(tr1, j, i, cross_y_one_side_mlp(r0, r1, r2, r3, j, i, loca, dx, dt, gamma, 1, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff, mlp_value_only))
            write_vec(tr2, j, i, cross_y_one_side_mlp(r0, r1, r2, r3, j, i, loca, dx, dt, gamma, 2, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff, mlp_value_only))
            write_vec(tr3, j, i, cross_y_one_side_mlp(r0, r1, r2, r3, j, i, loca, dx, dt, gamma, 3, w1, b1, w2, b2, w3, b3, w4, b4, eno_cutoff, mlp_value_only))
