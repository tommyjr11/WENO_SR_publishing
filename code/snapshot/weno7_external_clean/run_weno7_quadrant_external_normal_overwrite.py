...
import warp_weno7_mlp_beta_overwrite as ext
...
def run_solution(
    ...
    while t < args.t_end and step < args.max_steps:
        ...
        if mlp_params is None:
            ...
            ext.launch_weno7_ader4_step_external_mlp_normal(
                arrays,
                params,
                dt,
                args.device,
...
def run(args: argparse.Namespace) -> None:
    ...
    mlp_params = weno7.load_mlp_params(args.model, args.device) if args.model is not None and args.run_mlp else None
    ...
    print(
        ...
        "external_beta_normal=overwrite",
        flush=True,
    )
    ...
    if args.run_mlp:
        ...
        plot_qstyle(
            ...
            f"WENO7 MLP external-overwrite {args.quadrant_case} {args.riemann_solver} {params.nx}x{params.ny} t={summaries['mlp']['t']:.3f}",
        )
