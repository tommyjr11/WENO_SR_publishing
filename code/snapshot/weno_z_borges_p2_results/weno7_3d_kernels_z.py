...
from . import weno7_helpers_z as W7
...
def characteristic_weno7_x(
    ...
    q4: Vec5d, q5: Vec5d, q6: Vec5d, lr: int, h: wp.float64,
) -> Vec5d:
    roe_left = q2
    roe_right = q3
    if lr == 1:
    ...
    return B.matvec5(right_matrix, weno7_face_vec(c0, c1, c2, c3, c4, c5, c6, lr, h))
...
def normal_x_kernel(
    ...
    left_value = characteristic_weno7_x(q0, q1, q2, q3, q4, q5, q6, 2, h)
    ...
    right_value = characteristic_weno7_x(r0, r1, r2, r3, r4, r5, r6, 1, h)
...
def normal_y_kernel(
    ...
    left_value = characteristic_weno7_y(q0, q1, q2, q3, q4, q5, q6, 2, h)
    ...
    right_value = characteristic_weno7_y(r0, r1, r2, r3, r4, r5, r6, 1, h)
    B.store_vec(left, k, j, i, left_value)
    B.store_vec(right, k, j, i, right_value)
...
def normal_z_kernel(
    ...
    left_value = characteristic_weno7_z(q0, q1, q2, q3, q4, q5, q6, 2, h)
    ...
    right_value = characteristic_weno7_z(r0, r1, r2, r3, r4, r5, r6, 1, h)
    B.store_vec(left, k, j, i, left_value)
    B.store_vec(right, k, j, i, right_value)


@wp.func
def transverse_x_value(source: wp.array4d(dtype=wp.float64), k: int, j: int, i: int, location: int, h: wp.float64) -> Vec5d:
    return weno7_gauss_vec(
        ...
        B.load_vec(source, k, j, i + 7), location, h,
    )


@wp.func
def transverse_y_value(source: wp.array4d(dtype=wp.float64), k: int, j: int, i: int, location: int, h: wp.float64) -> Vec5d:
    return weno7_gauss_vec(
        ...
        B.load_vec(source, k, j + 7, i), location, h,
    )


@wp.func
def transverse_z_value(source: wp.array4d(dtype=wp.float64), k: int, j: int, i: int, location: int, h: wp.float64) -> Vec5d:
    return weno7_gauss_vec(
        ...
        B.load_vec(source, k + 7, j, i), location, h,
    )
...
def transverse_x_kernel(
    ...
    k, j, i = wp.tid()
    B.store_vec(target_left, k, j, i, transverse_x_value(source_left, k, j, i, location, h))
    B.store_vec(target_right, k, j, i, transverse_x_value(source_right, k, j, i, location, h))
...
def transverse_y_kernel(
    ...
    k, j, i = wp.tid()
    B.store_vec(target_left, k, j, i, transverse_y_value(source_left, k, j, i, location, h))
    B.store_vec(target_right, k, j, i, transverse_y_value(source_right, k, j, i, location, h))
...
def transverse_z_kernel(
    ...
    k, j, i = wp.tid()
    B.store_vec(target_left, k, j, i, transverse_z_value(source_left, k, j, i, location, h))
    B.store_vec(target_right, k, j, i, transverse_z_value(source_right, k, j, i, location, h))
