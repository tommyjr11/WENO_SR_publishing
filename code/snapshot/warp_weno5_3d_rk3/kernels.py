...
@wp.func
def weno_face_scalar(q0: wp.float64, q1: wp.float64, q2: wp.float64, q3: wp.float64, q4: wp.float64, lr: int) -> wp.float64:
...
@wp.func
def weno_face_vec(q0: Vec5d, q1: Vec5d, q2: Vec5d, q3: Vec5d, q4: Vec5d, lr: int) -> Vec5d:
    result = Vec5d()
    for component in range(5):
        result[component] = weno_face_scalar(q0[component], q1[component], q2[component], q3[component], q4[component], lr)
    return result


@wp.func
def characteristic_weno_face_x(q0: Vec5d, q1: Vec5d, q2: Vec5d, q3: Vec5d, q4: Vec5d, lr: int) -> Vec5d:
    left_index_state = q1
    ...
    characteristic = weno_face_vec(c0, c1, c2, c3, c4, lr)
    return matvec5(right_matrix, characteristic)


@wp.func
def characteristic_weno_face_y(q0: Vec5d, q1: Vec5d, q2: Vec5d, q3: Vec5d, q4: Vec5d, lr: int) -> Vec5d:
    left_index_state = q1
    right_index_state = q2
    if lr == 1:
        left_index_state = q2
...
@wp.func
def characteristic_weno_face_z(q0: Vec5d, q1: Vec5d, q2: Vec5d, q3: Vec5d, q4: Vec5d, lr: int) -> Vec5d:
    left_index_state = q1
    right_index_state = q2
    if lr == 1:
        left_index_state = q2
...
@wp.func
def gauss_weno_scalar(q0: wp.float64, q1: wp.float64, q2: wp.float64, q3: wp.float64, q4: wp.float64, lr: int) -> wp.float64:
    beta0 = weno_beta0(q0, q1, q2)
    beta1 = weno_beta1(q1, q2, q3)
    beta2 = weno_beta2(q2, q3, q4)
...
@wp.func
def gauss_weno_vec(q0: Vec5d, q1: Vec5d, q2: Vec5d, q3: Vec5d, q4: Vec5d, lr: int) -> Vec5d:
    result = Vec5d()
    for component in range(5):
        result[component] = gauss_weno_scalar(q0[component], q1[component], q2[component], q3[component], q4[component], lr)
    return result
...
def normal_x_kernel(
    ...
    left_value = characteristic_weno_face_x(q0, q1, q2, q3, q4, 2)
    ...
    right_value = characteristic_weno_face_x(r0, r1, r2, r3, r4, 1)
...
def normal_y_kernel(
    ...
    left_value = characteristic_weno_face_y(q0, q1, q2, q3, q4, 2)
    ...
    right_value = characteristic_weno_face_y(r0, r1, r2, r3, r4, 1)
    store_vec(left, k, j, i, left_value)
    store_vec(right, k, j, i, right_value)
...
def normal_z_kernel(
    ...
    left_value = characteristic_weno_face_z(q0, q1, q2, q3, q4, 2)
    ...
    right_value = characteristic_weno_face_z(r0, r1, r2, r3, r4, 1)
    store_vec(left, k, j, i, left_value)
    store_vec(right, k, j, i, right_value)


@wp.func
def transverse_y_value(source: wp.array4d(dtype=wp.float64), k: int, j: int, i: int, lr: int) -> Vec5d:
...
@wp.func
def transverse_x_value(source: wp.array4d(dtype=wp.float64), k: int, j: int, i: int, lr: int) -> Vec5d:
    return gauss_weno_vec(
...
@wp.func
def transverse_z_value(source: wp.array4d(dtype=wp.float64), k: int, j: int, i: int, lr: int) -> Vec5d:
    return gauss_weno_vec(
...
def transverse_y_kernel(
    ...
    k, j, i = wp.tid()
    store_vec(target_left, k, j, i, transverse_y_value(source_left, k, j, i, lr))
    store_vec(target_right, k, j, i, transverse_y_value(source_right, k, j, i, lr))
...
def transverse_x_kernel(
    ...
    k, j, i = wp.tid()
    store_vec(target_left, k, j, i, transverse_x_value(source_left, k, j, i, lr))
    store_vec(target_right, k, j, i, transverse_x_value(source_right, k, j, i, lr))
...
def transverse_z_kernel(
    ...
    k, j, i = wp.tid()
    store_vec(target_left, k, j, i, transverse_z_value(source_left, k, j, i, lr))
    store_vec(target_right, k, j, i, transverse_z_value(source_right, k, j, i, lr))
