...
EXTERNAL_ROOT = ROOT / "weno7_external_clean"
for path in (ROOT, EXTERNAL_ROOT):
...
from run_weno7_quadrant_torch_beta_all import TorchWeno7Beta as _TorchWeno7Beta

from weno7_point_rk4_shu import point_rk4 as base
