...
python3 -u -m for_paper_results.run_quadrant --case c3 --nx 400 --ny 400 --cfl 0.4 --t-end 0.5 --init-quadrature 15 --device "$DEVICE"
python3 -u -m weno_z_borges_p2_results.run_quadrant --case c3 --nx 400 --ny 400 --cfl 0.4 --t-end 0.5 --init-quadrature 15 --device "$DEVICE"
