# Two-dimensional Riemann configuration C.3
...
The domain [0,1]^2 uses a 400x400 finite-volume mesh, outflow boundaries, characteristic HLLC fluxes, CFL 0.4, and t=0.50. Initial discontinuities are aligned with x=0.5 and y=0.5.

## Initial condition

States V1--V4 occupy the upper-right, upper-left, lower-left, and lower-right quadrants: V1=(1.5,0,0,1.5); V2=(0.5323,1.206,0,0.3); V3=(0.138,1.206,1.206,0.029); V4=(0.5323,0,1.206,0.3). Tensor-product 15x15 Gauss--Legendre quadrature constructs the initial finite-volume averages.
...
WENO-SR preserves the large-scale wave geometry while exposing finer contact and shear-layer structure than the order-matched JS solutions.
...
Pressure is shown in colour and density as black contours. Every method in this configuration shares one pressure normalisation and 32 equally spaced density levels on [0.16,1.71]. The physical coordinates are retained.
