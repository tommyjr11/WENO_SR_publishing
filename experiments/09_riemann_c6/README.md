# Two-dimensional Riemann configuration C.6
...
The domain [0,1]^2 uses a 400x400 finite-volume mesh, outflow boundaries, characteristic HLLC fluxes, CFL 0.4, and t=0.30. Initial discontinuities are aligned with x=0.5 and y=0.5.
...
The WENO-SR fields retain the common large-scale solution and resolve additional shear-layer detail without instability.
...
Pressure is shown in colour and density as black contours. Every method in this configuration shares one pressure normalisation and 25 equally spaced density levels on [0.54,2.94]. The physical coordinates are retained.
